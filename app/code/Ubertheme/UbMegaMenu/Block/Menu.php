...
class Menu extends \Magento\Framework\View\Element\Template implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    protected function _beforeToHtml()
    {
        ...
        if ($this->hasData('menu_id')) {
            ...
            $menuGroup = $this->dataHelper->getMenuGroupById($menuGroupId);
            ...
            $menuGroup = $this->dataHelper->getMenuGroupByKey($menuKey, $customerGroupId);
        ...
        $this->_configs['mobile_type'] = $menuGroup->getMobileType();
        $this->_configs['addition_class'] .= " {$this->_configs['mobile_type']}-root";
