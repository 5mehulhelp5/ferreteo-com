    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'required' => true,
                'note' => __('Animation effect you want to display sub-menu items (Tablet/Desktop only)'),
                'options' => $model->getAnimationTypeOptions(),
                'disabled' => $isElementDisabled
            ]
        );

        $note = __('<strong>- Accordion:</strong>');
        $note .= " " . __('A pull-down menu where clicking the main item expands the section below it<br/>');
        $note .= __('<strong>- Drilldown:</strong>');
        $note .= " " . __('Shows only the submenus of the last selected menu item');
        $fieldset->addField(
            'mobile_type',
            'select',
            [
