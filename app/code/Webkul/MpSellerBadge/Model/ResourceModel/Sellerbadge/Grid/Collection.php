 ...
 */
namespace Webkul\MpSellerBadge\Model\ResourceModel\Sellerbadge\Grid;

use Magento\Framework\Api\Search\SearchResultInterface as ApiSearchResultInterface;
use Webkul\MpSellerBadge\Model\ResourceModel\Sellerbadge\Collection as SellerbadgeCollection;
...
/**
 * Webkul\MpSellerBadge\Model\ResourceModel\Sellerbadge\Grid\Collection Class
 * Collection for displaying grid of MpSellerBadge Sellerbadge.
 */
class Collection extends SellerbadgeCollection implements ApiSearchResultInterface
{
    /**
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $sellerBadgeTable = $this->getTable('mpsellerbadge');
        $badgeTable = $this->getTable('mpbadges');
        $this->getSelect()->join(
            $joinTable.' as cgf',
        ...
        ->joinLeft(
            ...
            [
                'badge_id' => 'GROUP_CONCAT(mpb.badge_name , " ")'
            ]
        )
        ->where('main_table.store_id = 0')->group("main_table.entity_id");
