...
class Mosthelpful extends Action
{
            ...
            if (!empty($answers)) {
                foreach ($answers as $ans) {
                    ...
                    foreach ($reviews as $rev) {
                        $returnData = $this->
                        getForeachData($rev, $likes, $dislikes, $customerId, $key, $like, $dislike);
                        $likes = $returnData[0];
                    ...
                    $response['createdat']=
                    $this->_timezone->formatDate($ans->getCreatedAt(), \IntlDateFormatter::MEDIUM);
                }
            }
     ...
     */
    public function getForeachData($rev, $likes, $dislikes, $customerId, $key, $like, $dislike)
    {
