...
class Options extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mageplaza_productfinder_filter_options';
     ...
     * @var string
     */
    protected $_cacheTag = 'mageplaza_productfinder_filter_options';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mageplaza_productfinder_filter_options';
