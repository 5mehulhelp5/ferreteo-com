 ...
 */
class ExportProductsCsv extends Rule
{
    /**
     * @var FileFactory
     */
    ...
    public function execute()
    {
        ...
        $fileName = "mpproductfinder_filter_products_{$object->getId()}.csv";
        $content  = $this->_view->getLayout()->createBlock(Grid::class)->getCsvFile();
