        ...
        if (version_compare($context->getVersion(), '2.0.0', '<')) {
            ...
            if (!$installer->tableExists('mageplaza_faqs_article_category')) {
                $table = $installer->getConnection()
                    ...
                    ->addIndex(
                        $installer->getIdxName('mageplaza_faqs_article_category', ['category_id']),
                        ['category_id']
                    )
                    ->addIndex(
                        $installer->getIdxName('mageplaza_faqs_article_category', ['article_id']),
                        ['article_id']
                    )
                    ->addForeignKey(
                        $installer->getFkName(
                            'mageplaza_faqs_article_category',
                            'category_id',
                            'mageplaza_faqs_category',
                            'category_id'
                        ),
                        'category_id',
            ...
            if (!$installer->tableExists('mageplaza_faqs_article_product')) {
                $table = $installer->getConnection()
                    ...
                    ->addForeignKey(
                        $installer->getFkName(
                            'mageplaza_faqs_article_product',
                            'entity_id',
