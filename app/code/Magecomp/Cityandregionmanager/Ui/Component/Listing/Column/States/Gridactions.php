<?php
namespace Magecomp\Cityandregionmanager\Ui\Component\Listing\Column\States;
...
{
    const DATA_DELETE       = 'magecomp_cityandregionmanager/states/delete';
    const DATA_EDIT         = 'magecomp_cityandregionmanager/states/edit';
