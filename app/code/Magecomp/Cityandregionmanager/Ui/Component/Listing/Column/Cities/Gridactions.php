<?php
namespace Magecomp\Cityandregionmanager\Ui\Component\Listing\Column\Cities;
...
{
    const DATA_DELETE       = 'magecomp_cityandregionmanager/cities/delete';
    const DATA_EDIT         = 'magecomp_cityandregionmanager/cities/edit';
