...
class Upload extends Action
{
    ...
    {
        try{
            if(isset($this->getRequest()->getFiles("import_states_list")['name'])) {
                $uploader = $this->_uploaderFactory->create(['fileId' => 'import_states_list']);
                ...
                if(array_key_exists('file',$result) && array_key_exists('path',$result))
                {
                    ...
                    $this->session->setStatesFileName($finalpath);
                }
