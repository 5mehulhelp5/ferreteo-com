...
class EndQty extends Base
{
     ...
     * @param EndQtyValidator $validator
     * @param AbstractResource|null $resource
     * @param AbstractDb|null $resourceCollection
     * @param array $data
     */
    // phpcs:ignore Generic.CodeAnalysis.UselessOverridingMethod.Found -- EndQtyValidator
