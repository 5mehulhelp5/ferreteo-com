<?php
namespace Ibnab\BankInfo\Block\Info;
...
class BanktransferInfo extends \Magento\Sales\Block\Adminhtml\Order\View
{
    ...
    {
        return trim($this->_bankTransfer->getConfigData('activebank'));
    }
    public function getActivebankowner()
    {
        return trim($this->_bankTransfer->getConfigData('activebankowner'));
    }
