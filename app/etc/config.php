...
return [
    'modules' => [
        ...
        'Acx_ZoomEnvios' => 1,
        'Aitoc_Core' => 1,
        'Aitoc_ProductUnitsAndQuantities' => 1,
        'Amasty_Base' => 1,
        'Amasty_MWishlist' => 1,
        'Amazon_Core' => 1,
        'Amazon_Login' => 1,
        ...
        'Klarna_KpGraphQl' => 1,
        'Magebees_Attribute' => 1,
        'Magebees_Categories' => 1,
        'Magebees_SubcategoryListing' => 1,
        'Magecomp_Base' => 1,
        'Magecomp_Cancelorder' => 1,
        'Magecomp_Cityandregionmanager' => 0,
        'Magecomp_Ordertracking' => 1,
        'Magedelight_Base' => 0,
        'Magedelight_SMSProfile' => 0,
        'Mageplaza_Core' => 1,
